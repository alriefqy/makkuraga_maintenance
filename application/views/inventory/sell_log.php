    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          ...
          <form action="sell-log" method="GET">
          ...
          <div class="col-md-2 col-sm-2 col-xs-12">
             <select name="part_number" data-placeholder="Pilih Part Number" class="form-control select-search js-auto-submit" style="width:100%">
               ...
               <?php foreach ($part_number as $part_number ) { ?>
                <option <?php if(isset($_GET['part_number'])){if($_GET['part_number'] == $part_number['part_number']){echo "selected";}}?> value="<?php echo $part_number['id'] ?>"><?php echo $part_number['ID_alat'] ?></option>
              <?php } ?>
            </select> 
          </div>
          <div class="col-md-2 col-sm-2 col-xs-12">
             <select name="model" data-placeholder="Pilih Model" class="form-control select-search js-auto-submit" style="width:100%">
          ...
          <div class="col-md-2 col-sm-2 col-xs-12">
             <select name="ID_alat" data-placeholder="Pilih ID Alat" class="form-control select-search js-auto-submit" style="width:100%">
               <option value="">Semua ID</option>
               <?php foreach ($ID_alat as $ID_alat ) { ?>
                <option <?php if(isset($_GET['ID_alat'])){if($_GET['ID_alat'] == $ID_alat['ID']){echo "selected";}}?> value="<?php echo $ID_alat['ID'] ?>"><?php echo $ID_alat['ID'] ?></option>
              <?php } ?>
            </select> 
          </div>
          <div class="col-md-2 col-sm-2 col-xs-12">
