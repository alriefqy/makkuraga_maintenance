                ...
                <div class="row">
                  <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="x_content">
                        ...
                        <div class="item form-group">
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            <select name="prioritas" class="form-control select category" style="width:100%">
                             ...
                             <option value="GET & UC">GET & UC</option>
                             <option value="Hose">Hose</option>
                             <option value="Lubricant">Lubricant</option>
                             <option value="Light Truck">Light Truck</option>
                             <option value="Miscellaneous">Miscellaneous</option>
                             <option value="Seal">Seal</option>
                             <option value="Light Truck">Swing Drive</option>
                           </select>
                         </div>
                       </div>
                       <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Masukkan Cost (Rp) <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input class="form-control col-md-7 col-xs-12 cost" name="name" required="required" type="number">
                        </div>
                      </div>
                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Masukkan Price (Rp) <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input class="form-control col-md-7 col-xs-12 price_" name="name" required="required" type="number">
                        </div>
                      </div>
                      <div class="item form-group">
                      ...
                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Masukkan Owner <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input class="form-control col-md-7 col-xs-12 owner" name="owner" required="required" type="text">
                        </div>
                      </div>
  ...
  <tbody class="body-backlog">
    ...
    foreach($inventory as $inventory)
    {
      ...
      <tr id="<?php echo $inventory['id']?>">
        ...
        <td>Rp. <?php echo number_format($inventory['cost'],0,',','.'); ?></td>
        <td>Rp. <?php echo number_format($inventory['price'],0,',','.'); ?></td>
        ...
        <td><?php echo $inventory['owner'] ?></td>
          ...
          <div class="x_content">
            <form name="mechanic" class="form-horizontal form-label-left js-add-mechanic" method="post" novalidate>
              ...
              <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input class="form-control col-md-7 col-xs-12 cost_edit" required="required" type="number">
                </div>
              </div>
              <div class="item form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Masukkan Price (Rp) <span class="required">*</span>
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input class="form-control col-md-7 col-xs-12 price__edit" required="required" type="number">
                </div>
              </div>
              <div class="item form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="textarea">Masukkan Lokasi <span class="required">*</span>
              ...
              <div class="item form-group">
               ...
               <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input class="form-control col-md-7 col-xs-12 owner_edit" name="quantity" required="required" type="text">
                </div>
              </div>
