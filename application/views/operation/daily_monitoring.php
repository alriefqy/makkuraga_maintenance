          ...
          <div class="modal-dialog modal-lg">
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Input Operation</h4>
              </div>
                        ...
                        <div class="row">
                          <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="item form-group">
                             ...
                             <div class="col-md-6 col-sm-6 col-xs-12">
                               <input id="name" class="form-control col-md-7 col-xs-12 working" name="stop_hm" data-rule-required="true" type="text">
                             </div>
                           </div>
                           <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <select name="status" id="heard" class="form-control status" style="width:100%">
                                ...
                                <option value="Stand By Contractor">Stand By Contractor</option>
                          ...
                          <input type="hidden" class="user" value="<?php echo $this->session->userdata("id") ?>"
                ...
                <div class="control-group">
                  <div class="controls">
                    <div class="col-md-6 col-sm-6 col-xs-12 xdisplay_inputx form-group has-feedback">
                      <input type="text" autocomplete="off" value="  <?php echo date_indo($monitoring['tanggal']) ?>" <?php echo $access ?> data-id="<?php echo $monitoring['id_operation']?>" class="form-control date has-feedback-left js-tanggal" id="date" placeholder="Down Date" name="tanggal" aria-describedby="inputSuccess2Status3" style="width:190px" >
