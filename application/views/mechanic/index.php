                          ...
                          <div class="row">
                            ...
                            <div class="x_content">
                              ...
                              <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                <select name="lokasi" id="heard" class="form-control select location_mechanic" style="width:100%">
 									...
 									<div class="row">
 										...
 										<div class="x_content">
 											...
 											<div class="item form-group">
 												...
 												<div class="col-md-6 col-sm-6 col-xs-12">
                          <select id="mechanic" data-id="" name="mechanic_name" class="form-control select edit_location_mechanic" required style="width:100%">
                            <option value="Pusat">Pusat</option>
                            <option value="Asera">Asera</option>
                            <option value="Kodal">Kodal</option>
                          </select>
