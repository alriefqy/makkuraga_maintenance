 				...
 				<div class="modal-body">
 					<div class="row">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" autocomplete="off" class="form-control col-md-7 col-xs-12 password" required="required">
                        </div>
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-md-offset-3">
                         <input id="send_user_edit" name="submit_all" disabled type="submit" class="btn btn-success" value="Edit Data">
                       </div>
                     </div>
                   </form>
 									</div>
