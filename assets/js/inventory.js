      ...
      buttons: {
        confirm: function () {
          $.ajax({
            ...
            url:"save",
            data :{part_number:part_number,description:description,category:category,cost:cost,price:price,location:location,quantity:quantity,ideal_quantity:ideal_quantity,minimum_quantity:minimum_quantity,account_code:account_code,supplier:supplier,alokasi:alokasi,owner:owner},
  ...
  $.ajax({
    ...
    success: function(data){
          ...
          for(i=0; i<data.length; i++){
            ...
            $(e.currentTarget).find('.owner_edit').val(data[i].owner);
          }
          // $('#show_data').html(html);
    ...
    buttons: {
      confirm: function () {
        $.ajax({
          ...
          url:"editInventory",
          dataType:"JSON",
          data :{id:id,part_number:part_number,description:description,category:category,cost:cost,price:price,location:location,quantity:quantity,ideal_quantity:ideal_quantity,minimum_quantity:minimum_quantity,account_code:account_code,alokasi:alokasi,supplier:supplier,owner:owner},
          success: function(data){
